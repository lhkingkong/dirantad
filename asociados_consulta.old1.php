...
?>            
            ...
            Superficie total de Piso de Ventas: <?php echo $total_superficie; ?> m2</h4>  
           	<div class="contenu_onglet  sixteentab columns" id="contenu_onglet_general">

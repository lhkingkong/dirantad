  ...
  <div class="container contenidoA">
    <div class="fullcontainer">
      <div class="content_block leftTitle">
        <p class="title">El Consejo Directivo</p>
      </div>
    </div>
    <div class="clear"></div>
      ...
      <div class="boxA">
        ...
        <div class="list_block">
          <ul>
            ...
            <li>TIENDAS COMERCIALES MEXICANA, S.A. DE C.V.</li>
      ...
      <div class="boxA">
        ...
        <div class="list_block">
          <ul>
            ...
            <li>SEARS OPERARODA MÉXICO, S.A. DE C.V.</li>
            <li>SUPER GUTIERREZ, S.A. DE C.V.</li>
            <li>SUPER SANS FRANCISCO DE ASIS, S.A. DE C.V.</li>

...
<?php include "mainmenu.php" ?>
	...
	<div class="container contenidoA">
       ...
       <div class="content_block leftTitle">
		<p class="title">Contacto ANTAD</p>
        </div>
    <div class="sixteen columns">

		<div class="titulomovil">
        <p><titulos>Contacto ANTAD</titulos></p>
      </div>
	  </div>	
    <div class="clear"></div>       
			</div> 	
		<div class="one-second column contactoMargin">
		  <h1 class="red">Dirección</h1>			
            ...
            <tr>
            	...
            	<td>Cecilia León o Yaxiri Barona</td>
            </tr>
            <tr>
            	<td><strong>Correo electrónico:&nbsp;</strong></td>
            	<td><a href="mailto:cleon@antad.net">cleon@antad.net</a> o <a href="mailto:ybarona@antad.net">ybarona@antad.net</a></td>
            </tr>   
            <tr>

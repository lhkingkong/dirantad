...
<div class="fullscreen">
  ...
  <div class="content_block leftTitle">
    ...
    <!-- organigrama grande -->
    <div class="wrapDiv orgDiv bigOrg" style="height:500px;">
      <div class="organigrama">
        ...
        </a> <a href="#" onClick="alertaDiv('#div-oH'); return false;">
        <div id="oH">Direcci&oacute;n de Relaciones con Gobierno</div>
        </a> <a href="#" onClick="alertaDiv('#div-oG'); return false;">
        ...
        </a> <a href="#" onClick="alertaDiv('#div-oJ'); return false;">
        <div id="oJ">Gerente de Desarrollo</div>
        </a> <a href="#" onClick="alertaDiv('#div-oK'); return false;">
        <div id="oK">Gerente de Membres&iacute;a</div>
        </a> <a href="#" onClick="alertaDiv('#div-oL'); return false;">
...
<div class="dialogo" id="div-oJ">
  <div class="contenidoMensaje">
    <p><span class="text_higlight">Gerente de Desarrollo</span><br>
      <br>
      <span class="title text_higlight">Ing. Francisco Martín Gómez-Favila</span><br>
      Ext. 232 <br>
      Correo Electrónico: <span  class="text_higlight">fmartin@antad.net</span> </p>
    <p>Ser una fuente de información sobre el Comercio Detallista, precisa, oportuna, confiable y automatizada, a través de la generación de indicadores económicos, así como realizar investigaciones y estudios que ayuden a la toma de decisiones para eficientar los procesos de distribución y comercialización, que permita a nuestros Asociados estar en la vanguardia del Comercio Detallista, en beneficio del consumidor.
      Facilitar los medios electrónicos a los Asociados para mejorar su comunicación y participación en Comités y reuniones de trabajo.</p>
    <p>Fuente de información electrónica de proveeduría para el Comercio Detallista.</p>
    <div class="centered">

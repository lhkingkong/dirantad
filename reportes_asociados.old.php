		...
		$(function(){
			$('#dg').datagrid({
				...
				onExpandRow: function(index,row){
					$('#ddv-'+index).datagrid({
						url:'reportes_asociados_getdetail.php?asociado_id='+row.asociado_id,
						fitColumns:false,
						singleSelect:true,
						height:'auto',
						columns:[[
...
<?php include "mainmenu.php" ?>
	...
	<table id="dg" style="height:500px"
			url="reportes_asociados_getdata.php" 
			singleSelect="true" fitColumns="true">

		<thead>
			<tr>
				<th field="asociado_nombrecomercial" width="40%">Cadena</th>
				<th field="asociado_razonsocial" width="40%">Razon Social</th>
			</tr>
		</thead>

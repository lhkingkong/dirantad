...
<div class="container">
	  		...
	  		<div class="fullcontainer">
				<div class="content_block" style="background-image: url(images/pleca03.png); height: 67px; width: 650px; border: 0px ">    
					<p class="title"><br>Los Formatos de Tiendas</p>		
				</div>				
			</div>
			
			<div class="sixteen columns">
            <p>La Asociacion Nacional de Tiendas de Autoservicios y Departamentales tiene como objetivo fundamental 
			el mantener y mejorar los sistemas de distribución de sus Asociados de acuerdo a las necesidades, deseos e intereses sociales y economicos.</p>
			   
			<div id="tabs">
			<ul>
				<li><a href="#tabs-1">Autoservicio</a></li>
				<li><a href="#tabs-2">Departamentales</a></li>
				<li><a href="#tabs-3">Especiales</a></li>
			</ul>
...
<div>		
<div><ul>	
<a href="#"><img src="images/asociado_megamercado.png" class="aligncenter" alt="" /></a>
            <p><strong>Superficie:</strong> superior a los 10 mile metros cuadrados de piso de venta aproximadamente.</p>
				<p><strong>Productos que maneja:</strong> toda la línea de mercancías.<br>
				  <br>
				  <strong>Particularidad:</strong> Ofrece una gran varieda de servicios adicionales, como servicios bancarios, óptica y reparadora de calzado entre otros.<br>
			    </p>	
</ul></div> 
</ul> </div>
...
<a href="#"><img src="images/asociado_hipermercado.png" class="aligncenter" alt="" /></a>
             ...
             <p> <strong>Superficie:</strong> oscila entre 4,501 y 10 mil metros cuadrados de piso de venta aproximadamente.</p>
			  ...
			  <p><strong>Particularidad:</strong> Ofrece servicios adicionales al consumidor como puede ser farmacia, cajeros automáticos y servicios de comida rápida.<br>
		      </p>
</ul></div> 
</ul> </div>
...
<div><ul>		
<div><ul>	
<a href="#"><img src="images/supermercadoretro.png" class="aligncenter" alt="" /></a>
...
<div><ul>
	<a href="#"><img src="images/homepage_image_2.png" class="aligncenter" alt="" /></a>
	 <p><strong>Superficie:</strong> mayor a los 2,500 metros cuadrados de piso de venta.</p>
			  ...
			  <p><strong>Particularidad:</strong> Tiene poca decoración en las tiendas, y no ofrece a sus clientes ningún tipo de servicio que signifique atención directa.<br>
		      </p>    
</ul></div> 
</ul> </div>
...
<div><ul>	
	<a href="#"><img src="images/homepage_image_2.png" class="aligncenter" alt="" /></a>
	 <p>Están enfocados al mayoreo y medio mayoreo dirigidos a ciertos sectores a través de membresia.<br>
				...
				<p><strong>Productos que maneja:</strong> abarrotes, perecederos, ropa y mercancías generales.<br>
			  </p>
</ul></div> 
</ul> </div>
...
<ul><div>			
<div><ul>	
	<a href="#"><img src="images//asociado_tiendadescuento.jpg" class="aligncenter" alt="" /></a>
...
<div><ul>		
            <p>effffffffffffffffffffffffffffffssssssssssssssssssssv</p>
...
<p><strong>Superficie:</strong> menor a los 500 metros cuadrados de piso de venta.</p>
			  ...
			  <p><strong>Particularidad:</strong> Unidades comerciales al detalle dedicadas a la venta de satisfactores inmediatos las 24 horas.<br>
</ul></div> 
</ul> </div>
...
<li>- Otros</li>
 ...
 <p><strong>Definición Piso de Venta:</strong> Superficie en la que tiene lugar el acceso al público, la exhibición de la mercancía y las actividades de promoción, publicidad, ventas y cobro.<br>
              No considera la superficie destinada a privados, oficinas y bodegas, área de corte de carne, locales comercialies que den al pasillo de cajas, área de recibo do cualquier otra área con la cual no tenga contacto con el consumidor.</p>   
			</div>
